...
//            display += "Sheild\n";
    ...
    private void Death()
    {
        ...
        // After death, wait for 5 seconds and revive the player
        StartCoroutine(RevivePlayer());
    }

    // Coroutine to handle the delay after death animation before reviving the player
    private IEnumerator RevivePlayer()
    {
        ...
        // Trigger "Revive" animation or any other transition if needed
        if (animator != null)
        {
